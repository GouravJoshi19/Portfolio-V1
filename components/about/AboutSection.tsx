  ...
  return (
    <section className="w-3/4 min-h-[450px] mx-auto max-lg:py-5">
      <div className="flex flex-row justify-between items-center max-lg:flex-col">
        ...
        <div className="basis-1/2 mt-5 lg:text-start  max-lg:flex flex-col items-center w-full p-2 text-center">
          ...
          <p className="text-lg font-semibold text-[#767676] my-3 max-lg:text-center">Hey, my name is Gourav Joshi, and I am pursuing the feild of Data Science.My passion is to create and develop solution to solve real world problems with
          data science.
          </p>
