...
export function HeroText() {
  return (
    <div className="lg:w-3/4self-startmt-10 max-lg:flex flex-col items-center max-lg:border-none w-full self-center">
      <h1 className="text-6xl font-bold text-[#2d2e32] max-lg:text-center lg:text-start">
        Data Scientist
      </h1>
      <p className="lg:w-3/4 text-2xl text-start text-[#555555] ps-1 py-5 max-lg:text-center w-full">
